        ...
        <div
            ...
            <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside"
                ...
                <div class="zigzagItem zigzagItem--right">
                    ...
                    <div class="zigzagItem__graphic" style="margin-top: 41px!important"><img style="width: 400px" src="{{asset('img/undraw_certificate_343v.svg')}}"
                                                                                             class="media media--image"
                                                                                             srcset="{{asset('img/undraw_certificate_343v.svg')}}"></div>
                </div>
                <div class="kt-grid__item">
                ...
                <div class="kt-login__body">
                    ...
                    <div class="kt-login__form">
                        <div class="kt-login__title">
                            <h3 style="color: black!important;font-weight: bold">Sign Up</h3>
                        </div>
