                    ...
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <div class="kt-portlet__body">
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="">
                                        <img src="{{asset('img/default-image.svg')}}"
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <textarea name="miniResume" id="description"
                                                  class="form-control"
                                                  rows="5"
                                                  placeholder="Describe your experience, training, etc that demonstrate your skills & passion. Also, describes the benefits they'll receive."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tags" id="tags"
                                               class="form-control"
                                               placeholder="Tags related to your listing..." style="width: 100px!important;">
                                    </div>
                                </div>
                            </div>
                        </div>
