            ...
            <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside"
                ...
                <div class="zigzagItem zigzagItem--right">
                    <div class="zigzagItem__content"><span class="zigzagItem__number"></span>
                        <h3 class="zigzagItem__title color-1 weight-text-m" style="color: white!important;">
                            Recover Password</h3><br>
                        <div class="zigzagItem__text"><h5 style="color: white!important;">Please Change Your Password And Login To Connect With
                                Verified Journalist from top tier Outlets </h5></div>
                    </div>
                    <div class="zigzagItem__graphic" style="margin-top: 41px!important;"><img
                                src="{{asset('img/undraw_co-working_825n.svg')}}"
                                class="media media--image"
                                srcset="{{asset('img/undraw_co-working_825n.svg')}}" style="width: 500px"></div>
                </div>
                <div class="kt-grid__item">
                        ...
                        <div class="kt-form" novalidate="novalidate" id="kt_login_form">
                            ...
                            <div class="kt-login__actions">
                                ...
                                <button onclick="changePass()" id="kt_login_signin_submit"
                                        class="btn btn-primary btn-elevate kt-login__btn-primary btn-sm"
