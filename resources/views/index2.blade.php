...
<head>
    ...
    <style tyle="text/css">body {
        ...
        .section.section--jptr1i9ns5j .color-1 {
            color: rgba(0, 0, 0, 1);
        }

        .section.section--jptr1i9ns5j {
            --color: rgba(0, 0, 0, 1);
        }

        .section.section--a3zp1wjn6zh a:not(.btn), .section.section--a3zp1wjn6zh .link {
            color: rgba(0, 18, 255, 1);
            --link-hover-bg: rgba(0, 18, 255, 0.05);
            --link-hover: rgb(0, 11, 153);
        }

        .section.section--a3zp1wjn6zh {
            --color-link: rgba(0, 18, 255, 1);
        }</style>
...
<header id="header" class="section header dark" style="--wr-max:1200px">
    <div class="wr color-1" style="margin-top:10px;margin-bottom:10px">
        <nav id="headerNav"><a id="headerLogo" href="/" class="header__logo" style="font-weight:500;font-size:26px">PRESS
            ...
            <div class="header__navCtas"><a href="{{URL::to('signup')}}" class="btn btn--c btn--primary"
                ...
                <a href="{{URL::to('login')}}" class="btn btn--c btn--primary"
                       style="color:#fff;background-color:rgba(0, 18, 255, 1)">Login</a>
                <a href="{{URL::to('/dashboard')}}" class="btn btn--c btn--primary"
                   style="color:#fff;background-color:rgba(0, 18, 255, 1)">Browse</a>
            </div>
        </nav>
    ...
    <nav id="headerDrawer" class="headerMenu col-dark-sec">
        ...
        <div class="headerMenu__wrapper" style="background-color:rgb(255, 255, 255)">
...
<div id="hero" class="section section--hero section--noPadding section--left dark section--jptr1i9ns5j"
     style="background-color:rgba(255, 255, 255, 1);min-height:100vh;--pdx-min-height:700px;--wr-max:1200px;color:rgba(0, 0, 0, 1)">
    <div id="headerSpacer" style="height:50px"></div>
    <div class="divider divider--tall">
        <svg viewBox="0 0 1695 876" xmlns="http://www.w3.org/2000/svg">
            <g fill="rgba(0, 18, 255, 1)" fill-rule="evenodd">
        ...
        <div class="ft__half">
            <div class="ft__wrapper" style="max-width:570px">
                <div class="ft__content"><h1 class="hero__title color-1 weight-title-h font-title">SCHEDULE <em><strong>PHONE
                    ...
                    <div class="hero__ctaInfo"><em>GET PAID FOR YOUR EXPERTISE</em>.</div>
                </div>
            </div>
        </div>
        <div class="ft__half pdx pdx--noOverflow pdxParent--smartphones pdx--devices-3" style="--pdx-maxheight:1">
            <div class="pdxItem pdxItem--smartphones">
                <svg viewBox="0 0 328 655" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                     class="pdxPhone">
                    <defs>
                        <path d="M0 45.86C0 20.532 20.532 0 45.86 0h236.28C307.468 0 328 20.532 328 45.86v562.286c0 25.328-20.532 45.86-45.86 45.86H45.86c-25.328 0-45.86-20.532-45.86-45.86V45.86z"
                              id="framePhoneThinDark-a"></path>
                        <filter x="-1.1%" y="-.5%" width="102.1%" height="101.1%" filterUnits="objectBoundingBox"
                                id="framePhoneThinDark-b">
                            <feMorphology radius="2" in="SourceAlpha" result="shadowSpreadInner1"></feMorphology>
                            <feGaussianBlur stdDeviation="2.5" in="shadowSpreadInner1"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <g>
                            ...
                            <use fill="#000" filter="url(#framePhoneThinDark-b)"
                                 xlink:href="#framePhoneThinDark-a"></use>
                        </g>
                        <path d="M14 47c0-18.778 15.222-34 34-34h232c18.778 0 34 15.222 34 34v560c0 18.778-15.222 34-34 34H48c-18.778 0-34-15.222-34-34V47z"
                              fill="transparent"></path>
                    </g>
                </svg>
                <div class="pdxContent"><img
                            src="https://landen.imgix.net/kr402kanl96f/assets/zowvoyuj.jpg?w=274&amp;h=574&amp;fit=crop"
                            srcset="https://landen.imgix.net/kr402kanl96f/assets/zowvoyuj.jpg?w=274&amp;h=574&amp;fit=crop,https://landen.imgix.net/kr402kanl96f/assets/zowvoyuj.jpg?w=274&amp;h=574&amp;fit=crop&amp;dpr=2 2x"
                            alt="PR Chat (2) copy 3.jpg"></div>
                <div class="pdxItem pdxItem--nestedPhone one">
                    <svg viewBox="0 0 328 655" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" class="pdxPhone">
                        <defs>
                            <path d="M0 45.86C0 20.532 20.532 0 45.86 0h236.28C307.468 0 328 20.532 328 45.86v562.286c0 25.328-20.532 45.86-45.86 45.86H45.86c-25.328 0-45.86-20.532-45.86-45.86V45.86z"
                                  id="framePhoneThinDark-a"></path>
                            <filter x="-1.1%" y="-.5%" width="102.1%" height="101.1%" filterUnits="objectBoundingBox"
                    ...
                    <div class="pdxContent"><img
                                src="https://landen.imgix.net/kr402kanl96f/assets/mpdmyu3f.jpg?w=274&amp;h=574&amp;fit=crop"
                                srcset="https://landen.imgix.net/kr402kanl96f/assets/mpdmyu3f.jpg?w=274&amp;h=574&amp;fit=crop,https://landen.imgix.net/kr402kanl96f/assets/mpdmyu3f.jpg?w=274&amp;h=574&amp;fit=crop&amp;dpr=2 2x"
                                alt="PR Chat (2) copy 4.jpg"></div>
                </div>
                <div class="pdxItem pdxItem--nestedPhone two">
                    <svg viewBox="0 0 328 655" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" class="pdxPhone">
                        <defs>
                            <path d="M0 45.86C0 20.532 20.532 0 45.86 0h236.28C307.468 0 328 20.532 328 45.86v562.286c0 25.328-20.532 45.86-45.86 45.86H45.86c-25.328 0-45.86-20.532-45.86-45.86V45.86z"
                    ...
                    <div class="pdxContent"><img
                                src="https://landen.imgix.net/kr402kanl96f/assets/qtll5wfb.jpg?w=274&amp;h=574&amp;fit=crop"
                                srcset="https://landen.imgix.net/kr402kanl96f/assets/qtll5wfb.jpg?w=274&amp;h=574&amp;fit=crop,https://landen.imgix.net/kr402kanl96f/assets/qtll5wfb.jpg?w=274&amp;h=574&amp;fit=crop&amp;dpr=2 2x"
                                alt="PR Chat (3).jpg"></div>
                </div>
            </div>
        </div>
    </div>
...
<div id="grid" class="section section--undefined section--center dark"
    ...
    <div class="divider divider--curve">
        <svg viewBox="0 0 1695 72" preserveAspectRatio="none">
            <path d="M0 0c282.5 45 565 67.5 847.5 67.5S1412.5 45 1695 0v72H0V0z" fill="rgba(249, 249, 249, 1)"
...
<footer id="footer" class="section section--footer section--center section--a3zp1wjn6zh"
        style="background-color:rgba(0, 0, 0, 1);padding-bottom:15px;padding-top:15px;--pdx-min-height:0px;--wr-max:1200px">
    <div class="wr">
        <div class="footer footer--simple">
            <div class="footer__primary"><span>Made with ☎️ | Press Chat © 2020 </span></div>
            <nav class="footer__linkRow"><a href="">Terms of Service</a><a href="">Privacy Policy</a></nav>
        </div>
    </div>
</footer>
<script>!function () {
        function e() {
            var e;
            window.innerWidth < s + l + 60 + (u ? 60 : 40) + 10 ? d.classList.add("header--withDrawer") : d.classList.remove("header--withDrawer"), r && (e = d.getBoundingClientRect().height, r.setAttribute("style", "height:" + e + "px"))
        }
        ...
        var d = document.getElementById("header"), n = document.getElementById("headerMenuButton"),
